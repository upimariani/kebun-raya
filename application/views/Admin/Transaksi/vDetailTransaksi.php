				...
				<div class="col-12">
					...
					?>
						<div class="callout callout-danger">
							...
							Boking Tiket dengan transaksi atas nama <strong><?= $detail['transaksi']->nama_wisatawan ?></strong> belum melakukan pembayaran!
						</div>
					<?php
					}
					?>
					...
					?>
						<div class="callout callout-warning">
							<h5><i class="fas fa-info"></i> Note:</h5>
							Boking Tiket dengan transaksi atas nama <strong><?= $detail['transaksi']->nama_wisatawan ?></strong> sedang menunggu konfirmasi kedatangan!
						</div>
					<?php
					}
					?>
					...
					<div class="invoice p-3 mb-3">
						...
						<div class="row invoice-info">
							<div class="col-sm-4 invoice-col">
								From
								<address>
									<strong><?= $detail['transaksi']->nama_wisatawan ?></strong><br>
									<?= $detail['transaksi']->alamat ?><br>

									<?= $detail['transaksi']->no_hp_wisatawan ?><br>
									Status Member : <?php if ($detail['transaksi']->member == '0') {
													?>
						...
						<div class="row no-print">
							<div class="col-12">
								...
								<a href="<?= base_url('Admin/cTransaksi') ?>" class="btn btn-danger"><i class="fas fa-reply"></i> Kembali</a>
